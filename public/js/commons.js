...
function renderNavBar(navbarId, exampleUri) {
  const examples = [
    ...
    },
    {
      ...
      name: 'diteksi Landmark'
    },
    {
      uri: 'webcam_face_expression_recognition',
      name: 'diteksi Ekspresi wajah'
    },
    {
      uri: 'webcam_age_and_gender_recognition',
      name: 'diteksi usia dan gender'
    },
    // {
  ...
  githubLink.classList.add('button', 'waves-light', 'side-by-side')
  githubLink.id = 'github-link'
  githubLink.href = 'https://github.com/justadudewhohacks/face-api.js'
  const h5 = document.createElement('h5')
  h5.innerHTML = 'Webcamp'
